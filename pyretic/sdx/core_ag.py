...
def sdx_restrict_state(sdx_config, participant):
    ...
    '''
    print "Restrict for:"+participant.id_
    #restrict_policy=passthrough
    #restrict_policy=parallel([policy for policy in participant.policies])
    #print restrict_policy
    #restrict_policy=parallel(participant.policies)
    #print restrict_policy
